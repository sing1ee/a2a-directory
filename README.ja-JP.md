...
| 名前 | 作者 | 説明 | Stars |
|------|--------|-------------|-------|
| [a2ajava](https://github.com/vishalmysore/a2ajava) | [@vishalmysore](https://github.com/vishalmysore) | Spring Boot アプリケーション向けの純粋な Java A2A プロトコル実装、クライアントとサーバーの両方の実装を含む | [![Stars](https://img.shields.io/github/stars/vishalmysore/a2ajava?style=social)](https://github.com/vishalmysore/a2ajava) |
