...
| [Agent Earn Radar](https://agent-earn-radar.vercel.app) | [@future-zhang](https://github.com/future-zhang) | Production A2A v0.3 JSON-RPC agent for discovering paid work that explicitly allows agent participation. Two free skills return a live listing sample or the x402 product catalog; paid x402 v2 routes provide filtered listings, opportunity risk packs, and cross-market intelligence for $0.05/$0.10/$1 USDC on Base. [Agent Card](https://agent-earn-radar.vercel.app/.well-known/agent-card.json) \| [OpenAPI](https://agent-earn-radar.vercel.app/openapi.json) | [![Stars](https://img.shields.io/github/stars/future-zhang/agent-earn-radar?style=social)](https://github.com/future-zhang/agent-earn-radar) |
...
| [Agent Earn Radar](https://agent-earn-radar.vercel.app) | [Agent Card](https://agent-earn-radar.vercel.app/.well-known/agent-card.json) · JSON-RPC endpoint `agent-earn-radar.vercel.app/api/a2a` |
